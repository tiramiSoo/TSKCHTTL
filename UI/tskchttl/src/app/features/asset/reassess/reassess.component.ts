...
@Component({
  selector: 'app-reassess',
  standalone: true,
  imports: [AgGridModule],
  templateUrl: './reassess.component.html',
  styleUrl: './reassess.component.css'
})
export class ReassessComponent {
  rowData: Asset[] = [];
  ...
  colDefs: ColDef[] = [
    ...
    { field: 'loaiTaiSan', headerName: 'Ngày đánh giá'},
    { field: 'loaiTaiSan', headerName: 'Mã tài sản'},
