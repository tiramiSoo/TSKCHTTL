...
@Component({
  selector: 'app-main-construction',
  standalone: true,
  imports: [AssetDetailComponent, AgGridModule, CommonModule],
  templateUrl: './main-construction.component.html',
  styleUrl: './main-construction.component.css'
})
export class MainConstructionComponent {
  rowData: Asset[] = [];
  selectedAsset: any;
